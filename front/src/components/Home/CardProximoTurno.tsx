...
export function ProfesionalTurnos({ nombre, horaproximo, servicioproximo, turnoshoy, libreshoy, profesionalId }: Props) {
    const [openCrearTurno, setOpenCrearTurno] = useState(false);
    ...
    return (
        <>
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div className="flex gap-2 pt-2">
                        ...
                        <Button
                            ...
                            onClick={() => setOpenCrearTurno(true)}
                        >
                            Crear Turno
                        </Button>
                    </div>
            ...
            <AgendaDialog
                open={openAgenda}
                onOpenChange={setOpenAgenda}
                profesionalId={profesionalId ?? 0}
                nombreProfesional={nombre}
            />

            <CrearTurnoDialog
                open={openCrearTurno}
                onOpenChange={setOpenCrearTurno}
                profesionalPreseleccionado={profesionalId}
            />
        </>
    );
}
