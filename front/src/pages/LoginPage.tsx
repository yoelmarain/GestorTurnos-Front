    ...
    return (
        <div className="flex flex-col items-center justify-center gap-8 p-6 w-96">
            ...
            <Card className="w-full max-w-md border-gray-800 bg-black/40 ">
                <CardHeader className="space-y-1"> {/* se usa space y no gap pq no es un ni flex o grid */}
                ...
                <CardFooter className="flex flex-col gap-3">
                    ...
                    <Button 
                        variant="outline" 
                        className="w-full border-gray-700 bg-transparent text-white hover:bg-gray-900 hover:text-white"
                    >
